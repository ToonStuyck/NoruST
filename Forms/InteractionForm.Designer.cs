namespace NoruST.Forms
{
    partial class InteractionForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.ui_ComboBox_SelectDataSets.Location = new System.Drawing.Point(107, 14);
			...
			this.label1.Text = "Select Variable 1";
			// 
			// ui_ComboBox_cat
			// 
			...
			this.label3.Text = "Select Variable 2";
			// 
